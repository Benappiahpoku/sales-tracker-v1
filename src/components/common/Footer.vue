<!--
  Footer.vue
  Stratonea/Sales Tracker - Footer with call to action and trust indicators
  - Mobile-first, touch-friendly, Ghana-optimized
  - WhatsApp integration, clear CTA, and trust signals
-->
  ...
  <section class="py-16 md:py-20 bg-primary text-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <p class="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
        Join thousands of Ghanaian businesses already using Sales Tracker to manage their sales professionally and efficiently.
      </p>
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
        ...
        <a
          href="https://wa.me/233594093926?text=Hi! I have questions about Sales Tracker"
          target="_blank"
...
// No logic needed for this static footer section.
// All styling and layout handled via Tailwind CSS utility classes.
</script>