...
<template>
  <!-- ===== [New Feature] START: Sale Details Modal ===== -->
  <!-- Modal Overlay -->
  <div 
    v-if="isOpen" 
...
// ===== Types & Interfaces =====
/**
 * Sale interface matching the data structure from SalesHistoryView
 */
interface Sale {
  id: string
  customerName: string
...
/**
 * Individual sale item interface
 */
interface SaleItem {
  name: string
  quantity: number
...
// ===== Computed Properties =====
/**
 * Mock sale items for demonstration
 * In a real app, this would come from the sale data or API
 */
...
/**
 * Calculate tax (12.5% VAT standard in Ghana)
 */
 ...
 * Creates formatted message with sale details for sharing
 */
function onShareWhatsApp() {
  ...
  // Open WhatsApp with the receipt message
...
<style scoped>
/* ===== [New Feature] START: Sale Details Modal Styling ===== */
